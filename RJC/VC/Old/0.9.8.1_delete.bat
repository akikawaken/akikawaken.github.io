@echo off
 ...
 echo %temp%\.RJC\update\%nextpath%\rtm-json-creator-v0.9.8.1.bat>%temp%\rjcupdate.tscf
 md %temp%\.RJC\update\%nextpath%\
 pushd %temp%\.RJC\update\%nextpath%\
 curl -sLJO https://github.com/akikawaken/Rtm_Json_Creator/releases/download/v0.9.8.1/rtm-json-creator-v0.9.8.1.bat
 echo Update completed.
 timeout /t 3 >nul
 call %temp%\.RJC\update\%nextpath%\rtm-json-creator-v0.9.8.1.bat
exit /b